...
export const useDashboardManagerStore = defineStore('dashboardManager', () => {
  ...
  const fetchDashboard = async (userId) => {
    ...
    try {
      const response = await managerDashboardServices.getDashboard(userId)
      stats.value    = response.data.data ?? {}
    } catch (err) {
      console.error('Gagal fetch manager dashboard:', err)
