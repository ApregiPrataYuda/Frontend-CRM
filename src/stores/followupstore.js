...
const fetchTimelineCustomer = async (id) => {
  ...
  const typeSubjectDirect = ref([
    ...
    // { value: 'Lainnya',              label: 'Lainnya'              },
      { value: 'Perkenalan Perusahaan',        label: 'Perkenalan Perusahaan' },
      { value: 'Perkenalan Produk/Layanan',    label: 'Perkenalan Produk/Layanan' },
      { value: 'Menggali Kebutuhan',           label: 'Menggali Kebutuhan' },
      { value: 'Kualifikasi Lead',             label: 'Kualifikasi Lead' },
      { value: 'Convert Menjadi Customer',     label: 'Convert Menjadi Customer' },
      { value: 'Presentasi Produk/Layanan',    label: 'Presentasi Produk/Layanan' },
      { value: 'Demo Produk/Layanan',          label: 'Demo Produk/Layanan' },
      { value: 'Pengiriman Company Profile',   label: 'Pengiriman Company Profile' },
      { value: 'Pengiriman Katalog Produk',    label: 'Pengiriman Katalog Produk' },
      { value: 'Pengiriman Penawaran Harga',   label: 'Pengiriman Penawaran Harga' },
      { value: 'Pengiriman Proposal',          label: 'Pengiriman Proposal' },
      { value: 'Diskusi Solusi',               label: 'Diskusi Solusi' },
      { value: 'Negosiasi Harga',              label: 'Negosiasi Harga' },
      { value: 'Negosiasi Kontrak',            label: 'Negosiasi Kontrak' },
      { value: 'Tindak Lanjut Penawaran',      label: 'Tindak Lanjut Penawaran' },
      { value: 'Menunggu Keputusan Customer',  label: 'Menunggu Keputusan Customer' },
      { value: 'Penjadwalan Meeting',          label: 'Penjadwalan Meeting' },
      { value: 'Kunjungan Lapangan',           label: 'Kunjungan Lapangan' },
      { value: 'Tidak Berminat',               label: 'Tidak Berminat' },
      { value: 'Lead Tidak Dapat Dihubungi',   label: 'Lead Tidak Dapat Dihubungi' },
      { value: 'Lainnya',                      label: 'Lainnya' },
  ])
