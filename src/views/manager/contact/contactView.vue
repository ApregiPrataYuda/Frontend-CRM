...
// Default: 'card'. Tidak disimpan ke localStorage supaya konsisten
// dengan halaman lain di aplikasi ini -- kalau nanti mau diingat per
// user, tinggal baca/tulis localStorage di sini.
        ...
        <div v-for="item in contactStore.contactsData" :key="item.id" class="contact-card">
          ...
          <div class="contact-card-actions">
            <button
              ...
              :class="{ 'act-disabled': item.source_type }"
              :title="item.source_type ? 'Linked contact, edit at source' : 'Edit'"
              :disabled="!!item.source_type"
            ...
            <button
              ...
              :title="item.source_type ? 'Unlink' : 'Delete'"
              :disabled="contactStore.deletingContact"
